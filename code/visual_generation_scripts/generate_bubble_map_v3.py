...
def create_bubble_map_v3():
    ...
    output_path = os.path.join(output_dir, 'MAI_Hotspots_BubbleMap_v3.png')
    
    plt.savefig(output_path, dpi=300, transparent=True, bbox_inches='tight')
    plt.close(fig)
    print(f"Bubble map v3 saved to {output_path}")

if __name__ == "__main__":
    create_bubble_map_v3()
